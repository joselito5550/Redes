                        ...
                        if(recibidos > 0){                                
                            if(strcmp(buffer,"SALIR\n") == 0){ 
								...
								if(arrayJugadores[jugadorId].isLogueado()){
									...
									else if(strcmp(cabecera,"UNA-LINEA\n")==0){
										cantarEstado(i,0,arrayPartidas,numPartidas);
									}
									else if(strcmp(cabecera,"DOS-LINEAS\n")==0){
										cantarEstado(i,1,arrayPartidas,numPartidas);
									}
									else if(strcmp(cabecera,"BINGO\n")==0){
										cantarEstado(i,2,arrayPartidas,numPartidas);
									}
								}
